...
class DocumentFlow:
    ...
    def process(self):
        ...
        bq_updater = BigqueryUpdater(specs.get_bq_parameters())
        #write to bucket and update
        try:
            specs.writer.upload_file(content)
            bq_updater.update_bigquery_row(column_updates, condition)
        except Exception as e:
            print(e)
...
class BigqueryUpdater:
    ...
    def update_bigquery_row(self, column_updates, condition):
        """
