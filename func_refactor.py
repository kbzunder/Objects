    ...
    def check_file_type(self):
        ...
        if self.type == 'pdf':
            ...
            if ('ocrmypdf' in metadata.get('/Creator', '')):
                ...
                writer = WriteFileToBucket(dest_bucket, dest_path)
            else:
                need_ocr = True
...
class WriteFileToBucket:
    ...
    def upload_file(self, file_data):
        ...
        if isinstance(file_data, str):
            ...
            self.blob.upload_from_file(file_data, rewind=True)  # Upload from BytesIO object
...
class FileProcessor:
    def __init__(self, bucket, name, DocumentCassifier, BigqueryUpdater):
        ...
        self.extractor, self.writer, self.content, self.dest_bucket, self.dest_file  = self.classifier.check_file_type()
