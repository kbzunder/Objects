...
class DocumentCassifier:
    def __init__(self,path):
        self.path = path
        self.downloader = DownloadFileFromBucket(self.path)
        self.file = self.downloader.download_file()
...
class FileProcessor:
    def __init__(self, bucket, name):
        ...
        self.classifier = DocumentCassifier(self.path)
        specs = self.classifier.check_file_type()
        self.extractor, self.writer = specs.extractor, specs.writer
        self.file, self.dest_bucket, self.dest_path = specs.file, specs.dest_bucket, specs.dest_file
